...
enum ShaderType{
    ...
    DIFFERED_SHADOWPASS_RENDERING_SHADER,
...
enum TextureTypeEnum {
    ...
    MATERIAL_TEXTURE,
    POSITION_TEXTURE,
	LIGHT_SPACE_POSITION_TEXTURE_ARRAY,
    DEPTH_TEXTURE,
	BACKGROUND_TEXTURE,
	R_TEXTURE,
	G_TEXTURE,
