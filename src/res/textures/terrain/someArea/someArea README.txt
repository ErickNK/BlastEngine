...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=someArea&box=25.520713,62.121319,24.925166,61.842845
...
-----------
  ...
  * someArea Height Map (ASTER 30m).png
  ...
  * someArea Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * someArea Height Map (SRTM30 Plus).png
